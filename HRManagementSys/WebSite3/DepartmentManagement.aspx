            ...
            <div class="row">
                ...
                <div class="col-md-3 col-lg-2 sidebar">
                    ...
                    <nav class="nav flex-column">
                        ...
                        <a class="nav-link active" href="DepartmentManagement.aspx">
                ...
                <div class="col-md-9 col-lg-10 main-content">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <asp:Button ID="btnAddDepartment" runat="server" Text="Add New Department" 
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mt-3">
                                                <div class="utilization-bar">
                                                    <div class="utilization-fill" style='width: <%# GetEmployeeUtilizationPercentage(DataBinder.Eval(Container.DataItem, "EmployeeCount"), DataBinder.Eval(Container.DataItem, "VacancyCount")) %>%'></div>
                                                </div>
                                            ...
                                            <div class="action-buttons mt-3">
                                                <asp:LinkButton ID="btnEdit" runat="server" CssClass="btn btn-primary" 
                                                    CommandName="EditDepartment" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "DepartmentId") %>'>
                                                    <i class="fas fa-edit"></i> Edit
                                                </asp:LinkButton>
                                                <asp:LinkButton ID="btnViewEmployees" runat="server" CssClass="btn btn-info"
                                                    CommandName="ViewEmployees" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "DepartmentId") %>'>
                                                    <i class="fas fa-users"></i> Employees
                                                </asp:LinkButton>
                                                <asp:LinkButton ID="btnManageEmployees" runat="server" CssClass="btn btn-warning"
                                                    CommandName="ManageEmployees" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "DepartmentId") %>'>
